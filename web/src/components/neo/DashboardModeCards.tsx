  ...
  return (
    <>
      <span
        ...
        aria-hidden
      />
      <svg viewBox="0 0 72 72" className="h-full w-full p-2 text-[#00CED1]" aria-hidden>
        <path
          fill="currentColor"
          fillOpacity={0.15}
          stroke="currentColor"
...
function Chevron() {
  return (
    <svg className="h-5 w-5 shrink-0 text-white/25 transition group-hover:translate-x-0.5 group-hover:text-[#00CED1]/85" viewBox="0 0 24 24" fill="none" aria-hidden>
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col justify-center px-4 pb-12 pt-5 sm:px-6 md:px-10 md:pb-16 md:pt-8">
      <div className="mx-auto w-full max-w-3xl">
        <div className="relative overflow-hidden rounded-[1.85rem] border border-white/[0.1] bg-gradient-to-b from-white/[0.09] via-[#0a0e16]/95 to-[#060910] p-6 shadow-[0_0_0_1px_rgba(0,206,209,0.12),0_8px_32px_rgba(0,0,0,0.35),0_32px_96px_rgba(0,0,0,0.4)] backdrop-blur-sm sm:p-8 md:p-11">
          <div
            className="pointer-events-none absolute -right-24 -top-28 h-72 w-72 rounded-full bg-[#00CED1]/[0.1] blur-3xl"
            aria-hidden
          />
          <div
          ...
          />
          <div
            className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#00CED1]/35 to-transparent"
            aria-hidden
          />

          <header className="relative text-center">
            <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-[#00CED1]/85">
              {brandName} · Home
            </p>
          ...
          <div className="relative mt-9 grid gap-4 sm:grid-cols-2 sm:gap-6">
            <Link
              href="/voice"
              className="group relative flex flex-col overflow-hidden rounded-2xl border border-white/[0.09] bg-gradient-to-br from-[#00CED1]/[0.14] via-[#00CED1]/[0.04] to-transparent p-5 transition duration-200 hover:-translate-y-0.5 hover:border-[#00CED1]/45 hover:shadow-[0_0_48px_rgba(0,206,209,0.16),0_16px_40px_rgba(0,0,0,0.25)] active:translate-y-0 sm:p-6"
            >
              <div className="mb-4 flex items-start justify-between gap-3">
                ...
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-[#00CED1]/15 text-[#00CED1] ring-1 ring-[#00CED1]/28">
                  <IconMicCenter />
                </span>
              </div>
            ...
            <Link
              href="/chat"
              className="group relative flex flex-col overflow-hidden rounded-2xl border border-white/[0.09] bg-gradient-to-br from-white/[0.07] via-white/[0.02] to-transparent p-5 transition duration-200 hover:-translate-y-0.5 hover:border-[#00CED1]/38 hover:bg-white/[0.05] hover:shadow-[0_0_40px_rgba(0,206,209,0.1),0_16px_40px_rgba(0,0,0,0.2)] active:translate-y-0 sm:p-6"
            >
              <div className="mb-4 flex items-start justify-between gap-3">
                <div className="relative flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-[#00CED1]/22 bg-[#0a1018]">
                  <ChatBubbleThumb />
                </div>
              ...
              <span className="mt-4 flex items-center gap-1.5 text-xs font-semibold text-[#00CED1]/95">
                Open thread <Chevron />
              </span>
            </Link>
          </div>
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
              {quickLinks.map(({ href, label, Icon }) => (
                <Link
                  key={href}
                  href={href}
                  className="inline-flex items-center gap-2 rounded-full border border-white/[0.1] bg-white/[0.04] px-4 py-2.5 text-[12px] font-medium text-white/80 shadow-sm transition hover:border-[#00CED1]/42 hover:bg-[#00CED1]/[0.08] hover:text-white hover:shadow-[0_0_20px_rgba(0,206,209,0.14)]"
                >
                  <Icon />
                  {label}
                </Link>
