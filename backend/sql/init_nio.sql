-- NEO backend — same schema as init_ai_users.sql, for database `nio` (e.g. Hostinger DB name).
-- Run: mysql -u nio -p -h 127.0.0.1 < sql/init_nio.sql

CREATE DATABASE IF NOT EXISTS `nio`
