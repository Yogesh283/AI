...
/** Legacy home / stats hub — open from Assistant (hamburger). */
    ...
    <View style={styles.root}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 48 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.greeting}>
          ...
          <View style={[neoUi.dividerGrad, { marginTop: 10 }]} />
        ...
        <View style={styles.refGrid}>
          {REF_TASKS.map((t, i) => (
            <Pressable
              key={t.label}
              style={[styles.refTile, neoUi.glassCardGlow]}
        ...
        <Pressable
          ...
          accessibilityLabel="Assistant — chat & voice"
        >
          <LinearGradient colors={[...neoGradientPrimary]} style={styles.micHeroGrad}>
            <Ionicons name="mic" size={34} color="#050912" />
          </LinearGradient>
          <Text style={styles.micHeroLabel}>Open assistant</Text>
        </Pressable>
        ...
        <View style={styles.grid}>
          {DASHBOARD.mainTiles.map((t, i) => (
            <Pressable
              key={t.label}
              style={[styles.tile, neoUi.glassCardGlow]}
              onPress={() => router.push(t.mobilePath as never)}
            >
        ...
        <Pressable onPress={() => router.push("/(tabs)")} style={{ marginTop: 16 }}>
          <LinearGradient colors={[...neoGradientPrimary]} style={styles.openChat}>
...
const styles = StyleSheet.create({
  root: { flex: 1, backgroundColor: NEO.bg, paddingTop: 12, paddingHorizontal: 20 },
  heroLogo: {
    alignItems: "center",
    marginBottom: 8,
    height: 120,
  ...
  subline: { marginTop: 10, fontSize: 14, color: NEO.muted, fontWeight: "500", lineHeight: 20 },
  section: {
    marginBottom: 10,
    marginTop: 4,
    fontSize: 11,
